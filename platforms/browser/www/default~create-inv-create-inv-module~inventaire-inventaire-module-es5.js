(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~create-inv-create-inv-module~inventaire-inventaire-module"], {
    ...
    function j0MG(module, __webpack_exports__, __webpack_require__) {
      ...
      var _config_environment__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../config/environment */
      "jsjn");
      /* harmony import */
      ...
      var CreateInvPage = /*#__PURE__*/function () {
        function CreateInvPage(crud, fTP, modalController, toastController, file, androidPermissions, filePath, zone) {
        ...
        _createClass(CreateInvPage, [{
          ...
          value: function upload() {
            var localPath = +this.file.dataDirectory + '/' + this.selectedValue.name;
            this.file.createFile(localPath, 'test.xls', false);
            this.fTP.download(localPath, '/Wms/' + this.selectedValue.name).subscribe(function (result) {
              console.log(result);
            }, function (error) {
    ...
    /***/
    function jsjn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
