...
/* harmony import */ var read_excel_file__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! read-excel-file */ "bBMC");
...
/* harmony import */ var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/file-opener/ngx */ "te5A");
...
let CreateInvPage = class CreateInvPage {
    constructor(crud, fTP, modalController, toastController, file, androidPermissions, filePath, zone, fileOpener) {
        this.crud = crud;
        this.fTP = fTP;
    ...
    excelRead(excel) {
        ...
        Object(read_excel_file__WEBPACK_IMPORTED_MODULE_6__["default"])(excel, { schema }).then((data) => {
            if (data.rows) {
